...
public interface IConnectionHandler<T>
{
    ...
    void OnSignalReceived(IConnection<T> connection, Packet<T> packet);
...
public record ConnectionHandler<T> : IConnectionHandler<T>
{
    ...
    public Action<IConnection<T>, Packet<T>>? SignalReceivedHandler { get; init; }
    ...
    public void OnSignalReceived(IConnection<T> connection, Packet<T> packet)
